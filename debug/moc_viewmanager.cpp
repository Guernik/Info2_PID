...
**
** Created: Wed 15. Feb 18:15:59 2012
...
const QMetaObject viewManager::staticMetaObject = {
    { &dbManager::staticMetaObject, qt_meta_stringdata_viewManager,
...
void *viewManager::qt_metacast(const char *_clname)
{
    ...
    return dbManager::qt_metacast(_clname);
}

int viewManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = dbManager::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
